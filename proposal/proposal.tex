...
\newpage{
	...
	\begin{center}
		...
		\vspace{15pt}
		\begin{tabular}{lr}
			\Large	Susheel Thapa [077BCT090]     & DEPARTMENT OF        \\
			\Large	Saurav Kr. Mahato [077BCT079] & ELECTRONICS AND      \\
...
\newpage{
	...
	\Large{
		\justify The main idea of this project is to create the MVP( Minimum Viable Product) to show the real life events happening in our daily life.

		\justify All we need was some databases to store the information related to call logs with some graphics, client-server model and of course OOP.

		\justify One will see some interface similar to their phone dial pad and will be able to type number and listen the specific sound of the number after pressing it.

		\justify After dialing the number, called window ( like in our daily life when call comes ) will appear on the screen.

		\justify Client side coding will require more time since it also includes graphics along with databases.
	}

	\justify{

		\begin {enumerate}
		\item This project rather than focusing over the development of existing system, it aims to understanding how things are working behind the scene.

		\item It aims to upgrade the knowledge one have in the field of communication
		\item It aims to provide information about does the NTC, Ncell knows to whom we are calling.
