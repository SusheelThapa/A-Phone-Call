...
\newpage{
	...
	\Large{
		\begin{enumerate}
			\item To learn OOPs concept
			\item To explore the unique features of C++ programming language.
			\item To gain upper hand in concept of networking and database.
			\item Exchange each other coding style
			\item To gather experience in working in group
		\end{enumerate}
	}
}
...
\newpage{
	...
	\Large{
		...
		\begin{center}
			...
			\includegraphics[width=450px, height=250px]{
