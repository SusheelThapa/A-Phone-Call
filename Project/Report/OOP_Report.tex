...
\newpage{
    ...
    \Large{
        ...
        \textbf{4. Literature Survey .................................................4\\}
        \vspace{15pt}

        \textbf{5. Existing System ...................................................5\\}
        \vspace{15pt}

        \textbf{6. Methodology ........................................................6}
        \vspace{15pt}

        \textbf{7. Implementation ....................................................8}
        \vspace{15pt}

        \textbf{8. Block Diagram  .....................................................9}
        \vspace{15pt}

        \textbf{9. Result  ..................................................................10}
        \vspace{15pt}

        \textbf{10. Problem faced and Solutions...............................11}
        \vspace{15pt}

        \textbf{11. Limitations and Future Enhancement.................12}
        \vspace{15pt}

        \textbf{12. Conclusion and Recommendations......................13}
        \vspace{15pt}

        \textbf{13. References...........................................................14}
        \vspace{15pt}
...
\newpage{
    ...
    \Large{
        \justify There are various applications of this kind of project if it gets big. It is summorized in the following paragraph:


        \justify As we all know, the field of communication is very huge. Everyone uses mobiles and they do call eachother to share their information in real time which is accomplished by this king of project model in big scale level.

        \justify With the use of big netowrking and commmunication protocols, this project can be taken up to further advanced level where real time communication will be possible with all the feactures.

        \justify Some of such company in Nepal are NCELL, NTC which has taken the whole market of communication. If imagined future, this project should have same future like this big companies do have now in Nepal.
...
\newpage{
    ...
    \Large{
        \justify Different survey and materials were researched while building this project for various purpose explained below:

        \justify 1. For GUI interface, differentwe needed a model of dialpad which was finalized to be taken from iphone.  \\
        2. SDL2 library in c++ were used to handle graphic purpose for this project. \\
        3. Figma was used to acheive the GUI interface of iphone dialpad and whole calling windows. \\
        4. For netowrking purpose and server, lot of things were researched and finally decided to use concept of files to handle the server task since there are not much material over the internet about networking in SDL2. \\
        5. For audio feacture, linux recording were used as temporary solution with limited 5 seconds recording and sending feacture between two clients( not real time ). \\
        6. .wav file was used with SDL2 for audio purpose. \\
        7. Finally, for writing different platform were researched and finally used LATEX.
    }
...
\newpage{
    ...
    \Large{
        ...
        \begin{center}
            \includegraphics[width=15cm , height= 10cm ]{../../resources/images/project/project-block_diagram.png}
        \end{center}
        \begin{center}
            Fig: Block Diagram of For Phone call
        \end{center}
...
\newpage{
    ...
    \Large{
        ...
        \includegraphics[width=15cm , height= 10cm ]{../../resources/screenshots/All-image-collapse.png}
        \begin{center}Fig: Above figure shows the result of the phone call simulation.
        \end{center}
    }
...
\newpage{
    ...
    \Large{
        A Phone call is the simulation of real world communication
        which perfectly demonstrate  how call gets establish between two user who are connected in network.\\

        We are able to complete the project with alot of helping hand and resources that are mention in References.\\

        Moreover, you can take this project to next level based on those things written under Limitation and Future Enhancement. For that, you need to have core concept of C++, networking with C++,SDL2 ,etc.
    ...
    \Large{
        \begin{enumerate}
            ...
            \item {Daya Sagar Baral and Diwakar Baral, “The Secrets of Object oriented Programming”, Bhundipuran Prakasan}
            \item {Bjarne Strooustrop ,”The C++ Programming Language”}
            \item  {Robert Lafore, “Object Oriented Programming with C++”, SamsPublication}
            \item  {Lazy foo Website}
        \end{enumerate}
    }
